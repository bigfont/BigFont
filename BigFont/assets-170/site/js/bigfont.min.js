...
﻿(function(){'use strict';var BASE_URL;BASE_URL=window.location.protocol+'//'+window.location.hostname+':'+window.location.port;function setupTheAnchorElementNonLinkBehavior(){$("a.non-link").click(function(e){e.preventDefault();e.stopPropagation();return false;});}
...
function setupNavigationClickHandler(){var collapsible,href,doDefault;$('nav#navigation a').click(function(e){collapsible=$('.in.collapse');if(collapsible.length>0){href=$(this).attr('href');collapsible.collapse('hide');window.location.hash=href;e.preventDefault();doDefault=false;}});return doDefault;}
