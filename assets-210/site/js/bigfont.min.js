...
function setupTheCollapsingContactForm(){var div,button,strong,span,forms,form,isValid,validator,jqxhr,scrollTopBefore,offsetTopBefore,scrollTopAfter,offsetTopAfter;function centerTheCollapsingContactForm(form){var id=form.attr('id');var target=$('[href*='+id+']');var targetTop=target.offset().top;var windowHeight=$(window).height();var scrollTop=targetTop-windowHeight/2;$('html,body').scrollTop(scrollTop);}
...
$(document).ready(function(){setupTheAnchorElementNonLinkBehavior();setupTheCollapsingContactForm();respondToQueryStringActionParameter();setupNavigationClickHandler();initializeTooltips();});}());