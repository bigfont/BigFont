<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMain.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="BigFont.Forms.Default1" %>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseTen">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_fernwoodroadcafe.png" /><span>Fernwood Road Cafe</span>
                            </a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseNine">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_ssidetailing.png" /><span>Gulf Island Detailing</span>
                            </a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseEight">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_davesblasting.png" /><span>Dave's Blasting</span>
                            </a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseSeven">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_gardenfaire.png" /><span>Garden Faire</span>
                            </a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseSix">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_fowlmoodfarm.png" /><span>Fowl Mood Farm</span>
                            </a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseFive">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_natureworks.png" /><span>Nature Works</span>
                            </a>
                        </div>
                            ...
                            <div class="accordion-inner">
                                <div class="caption">
                                    <div class="portfolio img-polaroid" data-src="http://www.saltspringnatureworks.ca">
                                        <img src="assets-250/site/img/portfolio_natureworks_large.png" />
                                    </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseFour">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_charityvillage.png" /><span>Charity Village</span>
                            </a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseTwo">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_healthchoices.png" /><span>Health Choices First</span>
                            </a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseOne">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_resaas.png" /><span>RESAAS</span>
                            </a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionClientList" href="#collapseZero">
                                <img class="img-icon img-polaroid img-circle" src="assets-250/site/img/portfolio_stage43.png" /><span>Stage 43</span>
                            </a>
                        </div>
